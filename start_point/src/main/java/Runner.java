...
//        computerDemo();
    ...
    public static void shoppingTrolleyDemo(){
        ...
        ShoppingTrolley trolley = new ShoppingTrolley(new ArrayList<>());

        // 2. Add an item to the trolley
        trolley.addItem("Apple");

        // 3. Count items in the trolley
        int itemCount = trolley.numOfItems();
        System.out.println("The trolley contains " + itemCount + " items.");

        // 4. Check if an item is in the trolley
        boolean itemInTrolley = trolley.checkItem("Apple");
        System.out.println("Is that item in the trolley? (true/false): " + itemInTrolley);
    }
